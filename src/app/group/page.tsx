...
export default function Group() {
    ...
    return (
        <section className="flex flex-col px-5 py-6 mobile:pb-10 mobile:w-[480px] mobile:mx-auto tablet:w-[640px] tablet:px-8 tablet:pt-6 laptop:pb-16  laptop:w-[1024px] leptop:px-10 laptop:py-8 desktop:w-[1280px] desktop:px-14">
